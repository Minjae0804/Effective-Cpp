...
// 
{
	...
	* 따라서 operation*으로 인해 할당된 메모리 공간은 프로그램 실행 동안 해제할 수 있는 방법이 영원히 사라진다.
	* 
	* 
	...
	* 간단히 말해서, 위의 경우 operator==은 (operator* 내부 정적 객체의 값)과 (operator* 내부 정적 객체의 값)을 비교한다.
	* 
